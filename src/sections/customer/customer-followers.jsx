...
export default function CustomerProfileFollowers({ followers }) {
...
CustomerProfileFollowers.propTypes = {
  followers: PropTypes.array,
};

// ----------------------------------------------------------------------

function CustomerFollowerItem({ follower, selected, onSelected }) {
...
CustomerFollowerItem.propTypes = {
