...
export default function CustomerProfileFriends({ friends, searchFriends, onSearchFriends }) {
...
CustomerProfileFriends.propTypes = {
...
function CustomerFriendCard({ friend }) {
