...
import CustomerProfilePostItem from './customer-post-item';

// ----------------------------------------------------------------------

export default function CustomerProfileHome({ info, posts }) {
    ...
    <Grid container spacing={3}>
      ...
      <Grid xs={12} md={8}>
        <Stack spacing={3}>
          ...
          {posts.map((post) => (
            <CustomerProfilePostItem key={post.id} post={post} />
          ))}
        </Stack>
      </Grid>
    </Grid>
