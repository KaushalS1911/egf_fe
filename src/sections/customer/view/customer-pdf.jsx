  ...
  const renderRow = (row, index, isLastRow) => {
    ...
    return (
      ...
      >
        ...
        <Text style={[styles.tableCell, { flex: 0.6 }]}>{fDate(row.joiningDate) || '-'}</Text>
        <Text style={[styles.tableCell, { flex: 0.5, borderRight: 0 }]}>{row.status || '-'}</Text>
      </View>
    );
  };
