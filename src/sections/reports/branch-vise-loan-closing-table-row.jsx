...
export default function BranchViseLoanClosingTableRow({ row,index, selected, onEditRow, onSelectRow, onDeleteRow, handleClick }) {
...
BranchViseLoanClosingTableRow.propTypes = {
