...
export default function LoanPartReleaseDetailsTableRow({ row,index, selected, onEditRow, onSelectRow, onDeleteRow, handleClick }) {
  const {from,to,penalty,days,loan,amountPaid,createdAt,remark} = row;
